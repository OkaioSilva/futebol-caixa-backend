  ...
  return transporter.sendMail({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; background: #f9f9f9; padding: 24px; border-radius: 8px; max-width: 480px; margin: auto;">
        ...
        <a href="${process.env.FRONTEND_URL}/register?token=${tokenConvite}" style="display: inline-block; padding: 12px 24px; background: #2ecc71; color: #fff; border-radius: 4px; text-decoration: none; font-weight: bold; margin: 16px 0;">Criar minha conta</a>
        <p>Se o botão não funcionar, copie e cole o link abaixo no seu navegador:</p>
        <p style="word-break: break-all; color: #555; font-size: 0.95em;">${process.env.FRONTEND_URL}/register?token=${tokenConvite}</p>
